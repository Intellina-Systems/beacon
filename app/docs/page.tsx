...
export default async function DocsPage() {
  ...
  return (
    <PageShell title="Docs" description="Personal, block-based documents you can share" actions={<NewDocButton />}>
      <div className="mx-auto w-full max-w-3xl space-y-8 px-4 py-5 lg:px-6">
        <section>
