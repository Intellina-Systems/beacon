  ...
  return (
    <PopoverPrimitive.Portal>
      <PopoverPrimitive.Content
        ...
        className={cn(
          // Cap to the space Radix measured between the trigger and the viewport
          // edge, so a long list inside a popover never renders past the bottom
          // of the screen where it can't be reached.
